...
VALUES("Combo desayuno 1", 1, 1, 2,"Combo fenomenal si comienzas el dia. Este combo Incluye lo siguiente: " , "35.99", "/prueba3.png","DESAYUNO");

INSERT INTO combo(nombre, postre_id, platillo_id, bebida_id, descripcion, precio,tiempo)
VALUES("Combo almuerzo 1", 2, 2, 1, "Un combo ideal para aquellos que disfruten a lo italian. Incluye Pie de Manzana, Calzone Italianisimo y una Clasica Coca-Cola.", "50.00","ALMUERZO");

INSERT INTO combo(nombre, postre_id, platillo_id, bebida_id, descripcion, precio, tiempo)
VALUES("Combo fit", 3, 3, 2, "Combo fenomenal si guardas la linea. Incluye un Helado,una Ensalada y un Te frio.", "47.00", "CENA");

INSERT INTO combo(nombre, postre_id, platillo_id, bebida_id, descripcion, precio, tiempo)
VALUES("Combo casual", 4, 4, 5, "Un combo que incluye un Helado un delicioso Minestrone y una Limonada.", "50.00", "CENA");

INSERT INTO combo(nombre, postre_id, platillo_id, bebida_id, descripcion, precio, tiempo)
VALUES("Combo pasta 1", 5, 5, 2, "Un combo clasico para los amantes de la pasta. Incluye una Banana Split, una deliciosa Lasana dalla Casa, y un Te frio", "45.00", "ALMUERZO");

INSERT INTO combo(nombre, postre_id, platillo_id, bebida_id, descripcion, precio, tiempo)
VALUES("Combo Frutti", 9, 10, 8, "Incluye un Cañoncito de Nutella, Rissoto Stracceti y un Capuchinno.","300.00","CENA");

INSERT INTO combo(nombre, postre_id, platillo_id, bebida_id, descripcion, precio, ruta_imagen,tiempo)
VALUES("Combo xibal zuppe", 7, 8, 6, "Combo fenomenal si para los amantes de la comida italiana.ste combo Incluye lo siguiente: " ,"450.00", "/prueba3.png","DESAYUNO");

INSERT INTO combo(nombre, postre_id, platillo_id, bebida_id, descripcion, precio, tiempo)
VALUES("Combo Parmigiana 1", 6, 6, 7, "Un combo para relajarse de manana.ste combo Incluye lo siguiente: ", "250.00","DESAYUNO");

INSERT INTO combo(nombre, postre_id, platillo_id, bebida_id, descripcion, precio, tiempo)
VALUES("Combo Cacciatora", 10, 7, 10, "Combo perfecto para unos bonitos recuerdos. Inclute Cinnamon Rolls, Exquisita Pasta a la Carbonara y una Malteada De Fresa.","169.00","ALMUERZO");

INSERT INTO combo(nombre, postre_id, platillo_id, bebida_id, descripcion, precio, tiempo)
VALUES("Combo pizza", 8, 9, 9, "Un combo para quedar saciados. Incluye un Croissant simple, una deleitosa Pizza Margherita y una Horchata","150.00","ALMUERZO");
